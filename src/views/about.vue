        ...
        <div class="rich_media_content " id="js_content" style="visibility: visible;">
          ...
          <section style="padding-top: 1px;padding-bottom: 1px;white-space: normal;font-size: 14px;">
            <h2
              ...
              <p style="border-color: rgb(176, 125, 62);"><span style="font-size: 18px;">索拉里斯在线教学平台</span></p></h2>
          </section>
          <p></p>
          <p style="white-space: normal;"><span style="font-size: 15px;letter-spacing: 1px;">从索拉里斯星的胶质海洋中迸发出的</span><br>
          </p>
          <p style="white-space: normal;"><span style="font-size: 15px;letter-spacing: 1px;">是人类好奇心的史诗<br></span>
          </p>
