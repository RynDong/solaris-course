    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <a
          ...
          href="#"
        >
          <i class="ace-icon fa fa-video-camera"></i>&nbsp;索拉里斯在线教学平台
        </a>
        <button
        ...
        >
          ...
          >您好：<img
              @click="openHomePage"
              class="avatar"
              :src="`https://api.multiavatar.com/${(loginMember.id || 'default')}.png`"
              alt=""
...
export default {
  ...
  methods: {
    ...
    openHomePage() {
      window.open(location.origin + "/home/" + this.loginMember.id);
    },
  },
};
</script>
